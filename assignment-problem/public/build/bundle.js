...
var app = (function () {
    ...
    /* src\TextComponent.svelte generated by Svelte v3.48.0 */

    const file$1 = "src\\TextComponent.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(/*goal*/ ctx[0]);
    			attr_dev(div, "class", "svelte-715nia");
    			toggle_class(div, "red-coloured", /*isQuestionMark*/ ctx[1]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<TextComponent> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ goal, isQuestionMark });

    	$$self.$inject_state = $$props => {
    		if ('goal' in $$props) $$invalidate(0, goal = $$props.goal);
    		if ('isQuestionMark' in $$props) $$invalidate(1, isQuestionMark = $$props.isQuestionMark);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*goal*/ 1) {
    			$$invalidate(1, isQuestionMark = goal ? (/[?]+/).test(goal) : false);
    		}
    	};

    	return [goal, isQuestionMark];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			label = element("label");
    			label.textContent = "Enter a goal";
    			t1 = space();
    			input = element("input");
    			t2 = space();
    			div1 = element("div");
    			create_component(textcomponent.$$.fragment);
    			attr_dev(label, "for", "goal");
    			add_location(label, file, 6, 2, 112);
    			attr_dev(input, "id", "goal");
    			attr_dev(input, "name", "goal");
    			attr_dev(input, "type", "text");
    			add_location(input, file, 7, 2, 153);
    			attr_dev(div0, "class", "container");
    			add_location(div0, file, 5, 0, 86);
    			add_location(div1, file, 9, 0, 222);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(textcomponent, div1, null);
    			current = true;
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*goal*/ 1) textcomponent_changes.goal = /*goal*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ TextComponent, goal });
